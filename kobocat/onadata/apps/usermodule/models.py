...
# Create fao_designations model


class FaoDesignations(models.Model):
    designations_name  = models.CharField(max_length=100)
    supervisor_id = models.IntegerField()

    def __str__(self):
        return self.designations_name

    class Meta:
        managed = False
        db_table = 'fao_designations'
...
class UserModuleProfile(models.Model):
    ...
    designation = models.ForeignKey('FaoDesignations', on_delete=models.CASCADE)
    mobile_no = models.CharField(max_length = 100)
    dls_officer_registration_no = models.CharField(max_length = 100)
    bvc_officer_registration_no = models.CharField(max_length=100)
