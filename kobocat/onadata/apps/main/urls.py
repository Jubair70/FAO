...
urlpatterns = patterns(
    ...
    url(r'^fao_module/', include('onadata.apps.fao_module.urls', namespace="fao_module")),
    ...
    url(r'^sync_ulo_forms_data/$','onadata.apps.main.views.sync_ulo_forms_data'),
    url(r'^get_designations/$', 'onadata.apps.main.views.get_designations'),
    url(r'^get_sample_submissions/$', 'onadata.apps.main.views.get_sample_submissions'),
    url(r'^get_sink_submissions/$', 'onadata.apps.main.views.get_sink_submissions'),
    url(r'^check_valid_user/$', 'onadata.apps.main.views.check_valid_user'),
    url(r'^check_valid_lab_user/$', 'onadata.apps.main.views.check_valid_lab_user'),
    url(r'^get_user_access_data/$', 'onadata.apps.main.views.get_user_access_data'),
    url(r'^get_user_id/$', 'onadata.apps.main.views.get_user_id'),
    url(r'^get_labs_list/$','onadata.apps.main.views.get_labs_list'),
    url(r'^sync_result_inputs_data/$','onadata.apps.main.views.sync_result_inputs_data'),
    url(r'^get_ai_sample_submissions/$','onadata.apps.main.views.get_ai_sample_submissions'),
	url(r'^get_medicine_list/$', 'onadata.apps.main.views.get_medicine_list'),
    url(r'^get_symptoms_list/$', 'onadata.apps.main.views.get_symptoms_list'),
    url(r'^get_diseases_list/$', 'onadata.apps.main.views.get_diseases_list'),
	url(r'^sync_lab_results_to_ulo/$', 'onadata.apps.main.views.sync_lab_results_to_ulo'),
	url(r'^get_sync_back/$','onadata.apps.main.views.get_sync_back'),
	url(r'^sync_device_id/$','onadata.apps.main.views.sync_device_id'),
    url(r'^sync_lab_tests/$','onadata.apps.main.views.sync_lab_tests'),
    url(r'^sync_ai_sample_from_lab/$','onadata.apps.main.views.sync_ai_sample_from_lab'),
    url(r'^get_previous_tests_data/$','onadata.apps.main.views.get_previous_tests_data'),
    url(r'^get_previous_ai_sample_data/$','onadata.apps.main.views.get_previous_ai_sample_data'),
    url(r'^sync_back_lab_results_to_lab/$','onadata.apps.main.views.sync_back_lab_results_to_lab'),
    url(r'^get_live_bird_markets/$','onadata.apps.main.views.get_live_bird_markets'),
    ################################# cup urls end ###################################
    url(r'^$', 'onadata.apps.fao_module.views.home_page'),
    ...
    url(r'^(?P<username>[^/]+)/forms/(?P<id_string>[^/]+)/settings$',
        'onadata.apps.main.views.show_project_settings', name='settings'),
    ...
    url(r'^(?P<username>[^/]+)/forms/(?P<id_string>[^/]+)/approvals$',
        'onadata.apps.approval.views.set_approval'),
    url(r'^data/approve$',
        'onadata.apps.approval.views.data_approve'),
    url(r'^data/reject$',
        'onadata.apps.approval.views.data_reject'),
    ...
    url(r"^stats/pending-approval/$", 'onadata.apps.approval.views.pending_approval'),
    url(r'^stats/data-approval/$', 'onadata.apps.approval.views.data_approval_list'),
    url(r'^data/approval-info/$', 'onadata.apps.approval.views.data_approval_list'),
    # briefcase api urls
    ...
    url(r"^(?P<username>\w+)/forms/(?P<id_string>[^/]+)/instance/edit-data/(?P<data_id>"
        "\d+)$", 'onadata.apps.logger.views.edit_data', name='edit_data'),
    url(r"^(?P<username>\w+)/forms/(?P<id_string>[^/]+)/data-inst-view-pending",
        'onadata.apps.viewer.views.pending_data_view'),
    ...
    url(r"^(?P<username>\w+)/forms/(?P<id_string>[^/]+)/instance/$",
        'onadata.apps.viewer.views.instance'),
    url(r"^(?P<username>\w+)/forms/(?P<id_string>[^/]+)/pending_instance/$",
        'onadata.apps.approval.views.pending_instance'),
    #url(r"^(?P<username>\w+)/forms/(?P<id_string>[^/]+)/instance/email/$",
     #   'onadata.apps.viewer.views.instance_email'),
    ...
    url(r"^xformsManifest/(?P<pk>[\d+^/]+)$",
        ...
        name='manifest-url'),
    url(r"^m/getschedule$",
        'onadata.apps.scheduling.schedule_utils.submit_user_schedule',
    ...
    url(r"^(?P<username>[^/]+)/custom_sms_submissions$",
        'onadata.apps.sms_support.views.import_sms_submissions',
        name='sms_submissions'),
