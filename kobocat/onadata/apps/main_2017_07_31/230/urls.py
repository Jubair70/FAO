...
urlpatterns = patterns(
    ...
    url(r'^(?P<username>[^/]+)/highchart',
        'onadata.apps.main.views.survey_summary'),
    url(r'^(?P<username>[^/]+)/querychart',
        'onadata.apps.main.views.query_chart'),
    url(r'^(?P<username>[^/]+)/sendmessage',
        'onadata.apps.main.views.sendMessageSubscriber'),
    ...
    url(r'^(?P<username>\w+)/forms/(?P<form_id_string>[^/]+)/excel_analyser\.xlsx$',
        'onadata.apps.logger.views.download_excel_analyser', name='download_excel_analyser'),
    ...
    #following url added for getting data of dynamic form data
    url(r"^(?P<username>\w+)/forms/(?P<id_string>[^/]+)/dynamic\.json",
        'onadata.apps.logger.views.get_xform_dynamic_status',
        name="get_xform_dynamic_status"),
    url(r'^(?P<username>[^/]+)/forms/(?P<id_string>[^/]+)/dynamicformdata$',
        'onadata.apps.logger.views.process_dynamic_data'),
