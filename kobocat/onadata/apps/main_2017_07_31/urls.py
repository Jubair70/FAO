...
urlpatterns = patterns(
    ...
    url(r'^hhmodule/', include('onadata.apps.hhmodule.urls', namespace="hhmodule")),
    ...
    # main website views
    ################################# cup urls start ###################################
    url(r'^cupdashboard/$', 'onadata.apps.hhmodule.views.cupDashboard', name='cupdashboard'),
    url(r'^household/profile/', 'onadata.apps.hhmodule.views.getHHProfile'),
    url(r'^household/members/', 'onadata.apps.hhmodule.views.getMemberLsit'),
    url(r'^household/snapshot-data/', 'onadata.apps.hhmodule.views.getSnapshotData'),
    url(r'^household-filter/', 'onadata.apps.hhmodule.views.filter_hh_list'),
    ################################# cup urls end ###################################
