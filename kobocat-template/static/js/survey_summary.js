...
function createTableRow(dataObj,submission,jsondata,title, ownership,form_permission){
    ...
    if ( isOwner ) {
        projectSettings = '<a href="/'+jsonOwner[dataObj][1]+'/forms/'+dataObj+'/'+'settings'+'" class="btn red btn-md" type="button"> Settings </a>';
      }
    if (Can_View){
    ...
    var spTableRowData = $('<td class="tg-yw4l"><a id = "project_link" href="/usermodule/'+jsonOwner[dataObj][1]+'/projects-views/' + dataObj + '/" >'+title+'<i class="icon-gap fa fa-external-link"></i></a><br>'
      + newSubmission + ' '+ details +' '+ projectSettings  + '</td><td class="tg-yw4l"><table class="table table-condensed"><tr><td class="half-width no-top">Last Submission</td><td class="half-width no-top">'+maxDate+'</td></tr><tr><td class="half-width">Today</td><td class="half-width">'+today+'</td></tr><tr><td class="half-width">This Month</td><td class="half-width">'+this_month+'</td></tr><tr><td class="half-width">Total</td><td class="half-width">'+length+'</td></tr></table></td><td class="tg-yw4l" id="'+dataObj+'" style="width:300px; min-width: 290px; height: 180px; margin: 0 auto"></td>');
